# L1-01 — PROV Primer publication status

[All research examples](../../README.md#learn-by-researching)

## Problem

Recover one official-source fact with an exact locator and temporal scope.
...
Evaluate source identity, exact status/date support, scope and truthful self-check.

Exact official status versus conformance overclaim; FX04/FX10. Producer only, no pack; canonical keyless quick start.
...
Benchmark mapping: `EX-L1-01`; L02/L04/L05; K01/K03/K11. See the [evaluation layers and quality dimensions](../../docs/04-testing-and-benchmark-spec.md).
