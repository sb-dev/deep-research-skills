...
[Progressive run](../../benchmarks/progressive/research/l4-02/research.md) contains the actual source-checkout output and its stated support and access limits. See the [separate review](../../benchmarks/progressive/research/l4-02/evaluation/audit.md) for assessed claims and remaining gaps.
